...
This tracks the cumulative number of mentions of the keywords `anvil nhgri` on Google Scholar. For example, for 2026 only, we'd see the number of hits with [this url](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C21&as_ylo=2026&q=anvil+nhgri&btnG=).
