...
The AnVIL Outreach Team uses Google Analytics to track usage and engagement of our **online web books**.

## Online Web Books: KPIs

```{r echo = FALSE, hide = TRUE, message = FALSE, warning = FALSE}
source(file.path("R","ga_plot_functions.R"))
knitr::kable(get_ga_kpis(ga_metrics_data = ga_metrics, ga_dimensions_data = ga_dimensions))
```

## Users by Online Book

```{r echo = FALSE, hide = TRUE, message = FALSE, warning = FALSE}
make_book_users_barchart(ga_metrics)
```

## Monthly Book Interactions

```{r echo = FALSE, hide = TRUE, message = FALSE, warning = FALSE}
make_session_monthly_sessions(ga_dimensions)
```

## Cumulative Book Interactions

```{r echo = FALSE, hide = TRUE, message = FALSE, warning = FALSE}
make_session_cumsum_sessions(ga_dimensions)
```
